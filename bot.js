    ...
    if(message.content.startsWith(prefix + "setname")) {
        ...
        message.channel.send(':white_check_mark: Done!').then(msg => {
          ...
          message.delete(5000);
		        ...
		        if(message.author.id !== myID) return;
            if(!args) return message.reply('اكتب الحالة اللي تريدها.');
        client.user.setGame(args , 'https://twitch.tv/Oscar');
        message.channel.send(':white_check_mark: Done!').then(msg => {
           msg.delete(5000);
          message.delete(5000);
        });
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=548825057221148683&permissions=8&scope=bot`)
        .setThumbnail(" https://cdn.discordapp.com/attachments/545629254545571840/548827231460524042/263ac46e30ffdee6a9882343a67d8aca.png")        
     message.channel.sendEmbed(embed);
       }
   });
